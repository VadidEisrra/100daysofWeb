...
class switch:
    """
        python-switch is a module-level implementation of the switch statement
        for Python. See https://github.com/mikeckennedy/python-switch for full
        details. Copyright Michael Kennedy (https://twitter.com/mkennedy)
    """
    ...
    def default(self, func: Callable[[], Any]):
        ...
        :param func: Any callable taking no parameters to be executed if this
    ...
    def case(self, key, func: Callable[[], Any], fallthrough=False):
        ...
        :param key: Key for the case test (if this is a list or range, the
        items will be added as a case)
        :param func: Any callable taking no parameters to be executed if this
        case matches
        :param fallthrough: Optionally fall through to the subsequent case
        (defaults to False)
        :return:
        """
